...
<html lang="en">
    ...
    <style>
      ...
      .masthead{
        background: linear-gradient(to bottom, rgb(0 0 0 / 40%) 0%, rgb(245 242 240 / 45%) 100%), url(https://mimsr.edu.in/wp-content/uploads/2020/09/Anti-Ragging-committee.jpg) !important;
    ...
    <body id="page-top" class="bg-dark">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">Online Ragging/harassment
Reporting System</a>
      ...
      <div class="container-fluid h-100">
          <div class="row h-100 align-items-center justify-content-center text-center">
              <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Welcome to Online Ragging/harassment
Reporting System </h3>
                  <hr class="divider my-4" />
              <div class="row mb-2 text-left justify-content-center ">
                 <button class="btn btn-primary" type="button" id="report_crime">Report a incident</button>
              </div>                        
              </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <div class="text-white">8899853504</div>
                    </div>
                    <div class="col-lg-4 mr-auto text-center">
                        <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
                        <!-- Make sure to change the email address in BOTH the anchor text and the link target below!-->
                        <a class="d-block" href="mailto:ary.bha.rt21@dypatil.edu">ary.bha.rt21@dypatil.edu</a>
                    </div>
                </div>
            </div>
            <br>Copy
